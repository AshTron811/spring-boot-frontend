...
public class FrontendController {
    ...
    // Update this with your deployed Python backend URL.
    ...
    public String captureLiveFaceSubmit(@RequestParam("name") String name,
                                        ...
                                        Model model) {
        // Create a request body with both "name" and "imageData"
    ...
    // Attendance Control page: provides both start and stop attendance options and shows live camera feed
